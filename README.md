...
2018_10_19 (Summation.py) Write a program that asks the user for a number n and prints the sum of the numbers 1 to n.

2018_10_22 (Summation3and5.py) Modify the previous program such that only multiples of three or five are considered in the sum, e.g. 3, 5, 6, 9, 10, 12, 15 for n=17
